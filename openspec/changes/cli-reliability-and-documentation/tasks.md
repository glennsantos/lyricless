...
- [x] 1.1 Replace player requirements with command-checkable single-file and batch criteria in `docs/specs/requirements.md`, `docs/specs/design.md`, and `docs/specs/tasks.md`.
...
- [x] 3.3 Update README and `docs/specs/requirements.md` for actual formats and stage-marker progress.
...
- [x] 4.3 Document batch layout and the narrow skip check in README and `docs/specs/requirements.md`.
...
- [x] 5.1 Pin the Audio Separator dependency and record the clean macOS arm64 Python 3.11 install and `pip check` result in README and `docs/support.md`.
...
- [x] 5.3 Check `assets/models/` references and remove or archive assets unused by a supported workflow; document that Audio Separator downloads its model files into `python/model_cache/`.
- [x] 5.4 Replace placeholder and machine-specific instructions; document installation, system dependencies, model setup and offline use, exit codes, batch results, model provenance, support limits, and benchmark limits.
- [x] 5.5 Record the automated checks, clean-environment real-audio check, and untested platform limits in `docs/support.md`.
